/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface WorkerBEnv` (hash: 3151b7185ea9b03f80916600750bbc61)
...
interface WorkerBEnv extends Cloudflare.Env {}
type StringifyValues<EnvType extends Record<string, unknown>> = {
	[Binding in keyof EnvType]: EnvType[Binding] extends string ? EnvType[Binding] : string;
};
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MY_VARIABLE">> {}
}
