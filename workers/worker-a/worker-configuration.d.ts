/* eslint-disable */
// Generated by Wrangler by running `wrangler types -c wrangler.jsonc -c ../worker-b/wrangler.jsonc --env-interface WorkerAEnv` (hash: 48b3598c53b73bb3e290f3a6805c0c5a)
...
declare namespace Cloudflare {
	...
	interface Env {
		API_URL?: "https://api.example.com";
		ANTHROPIC_API_KEY?: string;
		WORKER_B?: Service<typeof import("../worker-b/src/index").TestingRpc>;
	}
}
interface WorkerAEnv extends Cloudflare.Env {}
type StringifyValues<EnvType extends Record<string, unknown>> = {
	[Binding in keyof EnvType]: EnvType[Binding] extends string ? EnvType[Binding] : string;
};
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "API_URL" | "ANTHROPIC_API_KEY">> {}
}
